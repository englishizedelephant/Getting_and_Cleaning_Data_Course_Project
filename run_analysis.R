...
mean_std_dat <- dat[, c(mean_std_No, ncol(dat))]
head(mean_std_dat)
...
mean_std_dat[, ncol(mean_std_dat)] <-
  labels[mean_std_dat[, ncol(mean_std_dat)]]

head(mean_std_dat[, ncol(mean_std_dat)])
...
colnames(mean_std_dat)[ncol(mean_std_dat)] <- "activity"
colnames(mean_std_dat)
